...
\sechead{Section 3}
    ...
    Yes, parts of the reconstructed LGM ice limits are uncertain due to the
    lack of moraines or dated evidence. However, the discrepancies in ice
    extent discussed here are beyond uncertainties.
...
\sechead{Section 4}
    ...
    \citep[Fig.~5]{Wirsig.etal.2016} which we refer to is the most up-to date
    compilation of LGM ages in and around the Alps, and deglacial outlines like
    there exists for the Eurasian and Laurentide ice sheets are not available
    for the Alps.
    ...
    \citep[e.g.,][]{Monegato.etal.2007}. We appreciate your opinion, but the
    parts of the Alpine community sees our challenging of the trimline
    assumption as quite provocative given that it has been around for at least
    a century \citep{Penck.Bruckner.1909}.
