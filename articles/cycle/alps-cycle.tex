...
\begin{abstract}
    ...
    and 1\,km and up to 576~processors.
    Climate forcing is derived using present-day climate data from
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    respect to the modelled regional ice thickness. The result is
