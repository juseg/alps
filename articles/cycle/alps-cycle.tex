...
% ----------------------------------------------------------------------
    ...
    and viscous \emph{deformation} within the ice body \citep{Forbes.1846b}
    \todo{check ref. history from Guillaume}. As
...
% ----------------------------------------------------------------------
    ...
    40\,m, respectively. Simulations ran for \todo{how long?}
    using 36~processors.
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    temperature-independant controls on GRIP \chem{\delta^{18}O}
    \todo{ref}. In contrast,
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \todo{ref. Hantke}, and Eastern Alps \citep{Penck.Bruckner.1909,
    Husen.1987, Husen.2011, Bavec.Verbic.2011} \todo{ref. German Geologische
    Übersichtskarte 1:200,000}. Some of these maps have been compiled
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    accumulation areas, advanced eight times onto modern Lake
...
% ----------------------------------------------------------------------
    ...
    \begin{figure*}
      ...
      \caption{%
        ...
        \textbf{(b)} Modern July standard deviation \citep{Seguinot.2013} of
        daily mean temperature from the ERA-Interim \citep[1979--2012;][]{Dee.etal.2011}
        ...
        \todo{larger sub-fig. labels in all figs.}}
      \label{fig:inputs}
    \end{figure*}
    ...
    \begin{figure*}
      ...
      \caption{%
        ...
        \todo{move (b) label from behind legend.}}
    ...
    \begin{sidewaysfigure*}
      ...
      \caption{%
        ...
        transfluences (crosses) are shown. Modelled Last Glacial Maximum
        ...
        \todo{Enlarge to full width, make geological outline and transfluences
              more visible, rename Ivrea to Dora Baltea.}}
      \label{fig:lgmvel}
    \end{sidewaysfigure*}
    ...
    \begin{sidewaysfigure*}
      ...
      \caption{%
        ...
        \todo{Enlarge to full width, rename Ivrea to Dora Baltea.}}
      \label{fig:timing}
    \end{sidewaysfigure*}
    ...
    \begin{figure*}
      ...
      \caption{%
        ...
        \todo{Move glacier names into timeseries panels, change y-labels to
              glacier length, add new profiles, rename Ivrea to Dora Baltea.}}
      \label{fig:profiles}
    \end{figure*}
