...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    cycles (Fig.~\ref{fig:timeseries}b, light colour curves). Finally, the
    EPICA palaeo-temperature record has least variability the among records used
    (Fig.~\ref{fig:timeseries}a, red curves). This results in fewer variability
    in the total ice volume, and more restrictive glaciations during MIS~5
    and~3, (Fig.~\ref{fig:timeseries}b, red curves).

    \todo{comment on timing of the LGM}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    the Eastern Alps and in the Western Alps. Alternatively, the east-west
    ...
    \citep{Wu.etal.2007} and positive degree-day modelling of central European
    palaeo-glaciers \citep{Heyman.etal.2013}.
