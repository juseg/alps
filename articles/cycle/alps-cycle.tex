...
\begin{abstract}
    ...
    self-sustained ice domes. Modelled maximum ice surface is about 900\,m higher
    than observed trimline elevations, yet our simulation predicts little
    erosion at high elevation due to cold ice conditions. Finally, the Last
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    vigorous cooling experienced in Greenland is certainly not representative
    of the Alps.
    ...
    EPICA palaeo-temperature record has least variability among the records
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    warm towards thermodynamical equilibrium (supplementary animation).
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    inevitable. In this context, the model results challenge the assumption that
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    glacier dynamic controlled by spatial variations in subglacial topography
...
% ----------------------------------------------------------------------
    ...
    \begin{figure}
      ...
      \caption{%
        ...
        difference is 861\,m.
        \textbf{(c)} Modelled age of maximum ice thickness at the observed trimline
    ...
    \begin{figure*}
      ...
      \caption{%
        ...
        rougly following selected glacial valley centerlines for the Rhine,
        Rhone, Ivrea and Isère glaciers.
