...
\begin{abstract}
    ...
    mountain passes. Modelled maximum ice surface is 861\,m
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    Wohlfarth.etal.2008, Duprat-Oualid.etal.2017}, and cave speleothem in the
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \end{align}
    %
    with $\psi=0.169/2.4=0.0704$ \citep{Huybrechts.2002}. The control set of
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure*}[t]
      ...
      \caption{%
        ...
        \todo{Thicken the 200\,m contours on all figures. Remove ice domes and
              replace Straniger.}}
      \label{fig:lgmvel}
    \end{figure*}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure}[t]
      ...
      \caption{%
        ...
        the LGM cold-based ares (basal temperature above $1 \times 10^{-3}$\,K
    ...
    difference of $861\pm197$\,m (one standard deviation,
    Fig.~\ref{fig:trimlines}b), wich is significant in respect to the modelled
    regional ice thickness \todo{add a number}. The result is somewhat
    dependent on uncertain basal sliding and ice rheological parameters
    ...
    LGM cold-temperate basal thermal transition, or in cold-based areas
    (Fig.~\ref{fig:trimlines}c). The remaining discrepancies may relate to
    ...
    subglacial topography. Unfortunately, validation through the bedrock uplift
    rate \citep[cf.][]{Kuchar.etal.2012} is not doable in the Alps due its
    lower values, active tectonics and uncertainties on geological properties
    \citep[cf.][]{Mey.etal.2016}. However, the presence of an upper layer of
