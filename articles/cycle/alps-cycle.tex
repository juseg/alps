...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure}[t]
      ...
      \caption{%
        ...
        \todo{simplify basal thermal map, caption and main text.}}
      \label{fig:trimlines}
    \end{figure}
    ...
    modelled to have experienced warm-based ice for less than 1\,ka (7\,\%) of
    the MIS~2 (Fig.~\ref{fig:trimlines}c). This result is certainly affected by
    the limited ability of the 1\,km horizontal resolution to resolve
    small-scale topographic features. It calls for a more detailed comparison
