...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    criterion using a constant basal friction angle
    \citep[Table~\ref{tab:params};][Eq.~18]{Tulaczyk.etal.2000}.
    ...
    i.e. it is removed from the system in an accountable way.
