...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    $R$ is the ideal gas constant, and $A_{\mathrm{c}}$, $A_{\mathrm{w}}$,
    $Q_{\mathrm{c}}$, and $Q_{\mathrm{w}}$ are constant parameters
    corresponding to values measured below and above a~critical temperature
    threshold $T_{\mathrm{c}}$. The Clapeyron constant,
    $\beta$, the water fraction coefficient, $f$,
    The water fraction, $\omega$, is
    ...
    is an SIA enhancement factor which reflects the observed rheology of
    Holocene polar ice \citep[p.~77]{Cuffey.Paterson.2010}.
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    sliding velocity, $\vec{v}_{\mathrm{b}}$. The yield
    ...
    \end{align}
    %
    The amount of water at the base, $W$,
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    $\nu_{\mathrm{m}}$, the asthenosphere density, $\rho_{\mathrm{m}}$, and the
    lithosphere elastic rigidity, $D$, were set according to
