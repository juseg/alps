...
% ----------------------------------------------------------------------
    ...
    \begin{sidewaysfigure*}
      % scalebox is not necessary in production mode
      \centerline{\scalebox{0.9}{\includegraphics{alpcyc_hr_lgmvel}}}
      \caption{%
    ...
    \begin{sidewaysfigure*}
      % scalebox is not necessary in production mode
      \centerline{\scalebox{0.9}{\includegraphics{alpcyc_hr_timing}}}
      \caption{%
