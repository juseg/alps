...
% ----------------------------------------------------------------------
    ...
    \begin{figure}
      ...
      \caption{%
        \textbf{(a)} Modelled maximum ice thickness against observed trimline
        elevations \citep[Table~1]{Kelly.etal.2004}.
        \textbf{(b)} Histogram of modelled maximum ice thickness above trimline
        locations (500\,m bands). The average maximum ice thickness above the
        trimline is 979\,m.}
        \textbf{(c)} Modelled age of maximum ice thickness (colour) and maximum
        ice surface elevation (200\,m contours) above trimline locations
        \citep[Table~1]{Kelly.etal.2004} in the upper Rhone valley. Hatches
        mark glaciated areas with less than 1\,ka temperate ice cover during
        MIS~2 (29--14\,ka).
      \label{fig:trimlines}
    \end{figure}
