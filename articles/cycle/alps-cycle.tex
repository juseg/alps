...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    The modelled total ice volume reaches a maximum of 122.5\e{3}\,\unit{km^2},
    or 300.4\,mm of sea-level equivalent, at 24.56\,ka
    (Fig.~\ref{fig:lgmvel}b). A maximum glacierized area of
    163.3\e{3}\,\unit{km^2} is attained shortly aftewards at 24.57\,ka.
    ...
    Although the palaeo-climate forcing was adapted (Sect.~\label{sec:climate})
    ...
    (Fig.~\ref{footprints}b), which is likely unrealistic in at least this part
    of the model domain. On the other hand, the Durance glacier in the
