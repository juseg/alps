...
\sechead{Editor comments}
    ...
    The reference was added. However, to avoid redundancy with the next section
    on flow patterns, we would prefer to limit the discussion in this section
    to modelled ice marginal positions.
    ...
    With ``cf.~Ivy-Ochs, 2015; Wirsig et al., 2016, Fig. 5 for reviews'', we
    meant to refer to Fig.~5 in the paper by Wirsig et al. (2016). We have
    removed ``Fig.~5'' in this particular instance.
