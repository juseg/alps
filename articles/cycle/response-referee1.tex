...
\sechead{Trimlines}
    ...
    climate. To avoid confusion, Fig.~6c has been simplified.
    ...
    \msquote{%
        This result is certainly affected by the limited ability of the 1\,km
        horizontal resolution to resolve small-scale topographic features. It
        calls for a more detailed comparison.}
