...
\newcommand{\doi}[1]{doi:\allowbreak\href{http://dx.doi.org/#1}{#1}}
    ...
    the regional dataset by \citet{Isotta.etal.2013}, tailored to the dense
    station network and steep topography of the Alps, is certainly a more
    robust precitation forcing that needs to be considered in future
    ...
    extent regarding the south-western Alps,
