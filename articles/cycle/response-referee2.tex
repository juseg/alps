...
\sechead{Specific comments}
    ...
    forcing.  Arctic amplification could be an explanation if it was stronger
    ...
    implying a more regional mechanism than arctic amplification. Therefore, we
    decided not mention arctic amplification in the text.
