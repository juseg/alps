...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \todo{Ian: Given the importance of the sliding processes and dependence on
          basal shear stress. Is it worth the thought that "experience with the
          model shows that in the conditions applied here, till is mostly
          saturated and the model behaves similar to Weertman"?}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure}[ht]
      ...
      \caption{%
        ...
        \todo{Ian: make sure the legend matches the graph.}}
      \label{fig:basaldrag}
    \end{figure}
