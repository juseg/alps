...
% ----------------------------------------------------------------------
    ...
    glacial history is yet to be understood.
    ...
    preserved periglacial blockfields and others, including the Alps, do not
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure}
      ...
      \caption{%
        Modelled annual (domain-integrated) erosion volume (light curves) and 1-ka
        running mean (dark curves) in relation to modelled total ice volume in
        centimetres of sea-level equivalent. Blue indicates increasing ice
        volume and brown decreasing ice volume.}
      \label{fig:evolution}
    \end{figure}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure*}
      ...
      \caption{%
        \textbf{(a--d)} Modelled instantaneous erosion rate of the Rhine
          Glacier for selected glacier advance and retreat ages, and the final
          model state for topographic reference.
        \textbf{(e)} Interpolated instantaneous erosion rate along a Rhine
    ...
    insignificant erosion (Fig.~\ref{fig:transects}a and~b). The modelled
    erosion rates both increase and propagate inwards during periods of glacier
    retreat (Fig.~\ref{fig:transects}c and~e).
