    ...
    \begin{figure*}[ht]
      ...
      \caption{%
        ...
        \textbf{(b)} Modelled total ice volume in centimetres of sea-level
          ...
          \note{I have tried plotting cumulative erosion volume curve, but it
                looks almost like a straight line for all erosion laws.}}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \note{and plucking?} of a glacier flowing over a hard bed. Secondly, it is
...
% ----------------------------------------------------------------------
    ...
    \begin{itemize}
      ...
      \item This high spatialtemporal variability hints at a complex
