...
% ----------------------------------------------------------------------
    ...
    temperate ice-cover duration, and why some glaciated regions show
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \citep{Seguinot.2019, Seguinot.2020}.
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    system, thus neglecting its role in shielding the bedrock from glacier
    ...
    \begin{figure*}
      ...
      \caption{%
        ...
        \textbf{(b)} Modelled total ice volume in centimetres of sea-level
          ...
          stress-balance approximations and model horizontal resolution (see
          Sect.~\ref{sec:landscape}).}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure}
      ...
      \caption{%
        ...
        dashes indicates increasing ice volume and solid brown decreasing ice
        volume. Hatches indicate low confidence due to limited glacier volume.}
      \label{fig:evolution}
    \end{figure}
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    \begin{figure}
      ...
      \caption{%
        ...
        the Rhine Glacier during glacier advance (36\,ka, dashed blue), maximum
        extent (24\,ka, solid grey) and retreat (16\,ka, solid brown, using the
        same transect as in Fig.~\ref{fig:basaldrag}).
    ...
    a recent, independent study using PISM \citep{Lai.Anders.2021}.
...
% -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
    ...
    PISM's current mass-conservation heuristics \citep[appendix]{Imhof.2021}.
    Besides,
...
\codedataavailability{%
    ...
    (\doi{10.5281/zenodo.5084579}). Other model output variables were
    previously made available (\doi{10.5281/zenodo.3604174},
    \doi{10.5281/zenodo.3604142}).}

\videosupplement{
    Animations made available online show the spatio-temporal distribution of
    modelled glacier potential erosion rates
    (\url{https://vimeo.com/503162771}, supplementing
    Fig.~\ref{fig:cumulative}), the evolving relationship between ice volume
    and potential annual erosion volume (\url{https://vimeo.com/512478926},
    supplementing Fig.~\ref{fig:evolution}), and the distribution of potential
    erosion rate against bedrock altitude (\url{https://vimeo.com/512479008},
    supplementing Fig.~\ref{fig:hypsogram}).}
...
\begin{acknowledgements}
    ...
    Ivy-Ochs for being a constant (droid) motivator, Popi, Mattheos, Karsta,
    Stefan, Fran\c{c}oise and Dominique
    ...
    conversations while at University of Lausanne. Both authors thank
    an anonymous reviewer and Ian Evans (aided by Iestyn Barr, Jeremy Ely, Matt
    Tomkins, Pippa Whitehouse, Cristina Balaban and Matt Wiecek) for providing
    constructive feedback which has been incorporated in the present paper, and
    the associate editor Andreas Lang for handling the reviews.
