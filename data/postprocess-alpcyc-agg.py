...
for i in range(7):
    ...
    dt_file = rec + '3222cool{:04.0f}'.format(100*dt)
    run_dir = os.path.join(pism_dir, 'output', 'e9d2d1f', 'alps-wcnn-'+res,
                           dt_file+'+alpcyc4'+('+pp' if dp == 'pp' else ''))
    ...
    pp.to_netcdf(ofile, mode='w', encoding=encoding)
